...
import { FAN_CARDS, CARD_WIDTH_PCT } from "@/lib/cards";
...
export function CardFan() {
  return (
    <div className="w-full">
      ...
      <div className="relative mx-auto hidden w-full max-w-[1320px] md:block">
        <div
          className="relative w-full"
          style={{ aspectRatio: "1440 / 470" }}
        >
          ...
          <motion.div
            ...
            style={{ left: "77.5%", top: "-7%", width: "13%" }}
